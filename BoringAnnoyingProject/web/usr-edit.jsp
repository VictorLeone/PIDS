        ...
        <div class="card cadastro" style="width: 40%; margin: auto; min-width:350px;">
            ...
            <div class="cardContainer"> 
                ...
                <div class="text-center">
                    <h1 class="titulo">Editar Signed™</h1>
                </div>
                <div class="container-fluid">
                    <form  name="frmAddUser" action="UserController" onsubmit="return validateFormUsr()"  method="POST">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input id="sgid" type="hidden" class="form-control" name="usrid"  placeholder="Primeiro nome" value="<c:out value="${user.userid}" />" /> 
                                </div>
                                <div class="col-sm"> 
                                    <label>Usuário</label>
                        ...
                        <div class="text-center">
                            ...
                            <a href="principal.jsp"><button class=" btn botao" id="cadbt">Salvar</button></a>
